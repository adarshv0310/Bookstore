            ...
            <div className="flex flex-col items-center">
              ...
              <div className="w-full flex-1 mt-8">
                <div className=" flex flex-col gap-4">
                  <form onSubmit={handleSubmit} className='mx-auto max-w-xs flex flex-col gap-6'>
                    <input
                    ...
                    />
                    <input
                      className="w-full px-5 py-3 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white text-black"
                      type="password"
                      name="password"
                      value={password}
                      onChange={handleChange}
                  ...
                  <p className="mt-6 text-xs text-gray-600 text-center">
                    ...
                    <a href="/login">
                      <span className="text-pink-900 font-semibold">Login</span>
                    </a>
                  </p>
                </div>
              </div>
